...
As of commit `8610fd5`, GitHub Actions reports:

- `Smoke Tests`: success
- `Security Audit`: success
- `Release Readiness`: success; automated on `main` and pull requests, with manual `workflow_dispatch` still available
