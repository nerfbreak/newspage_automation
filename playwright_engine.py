...
def _render_progress_label(placeholder, dist, user, current, total):
    ...
    with placeholder.container():
        ...
        with c1:
            st.markdown(f"""
                <div id='terminate-target-col' style='display: flex; align-items: center; gap: 12px; flex-wrap: wrap; margin-top: 4px;'>
        ...
        with c3:
            st.markdown(f"""
                <div style='display: flex; align-items: center; gap: 12px; flex-wrap: wrap; justify-content: flex-end; margin-top: 4px;'>
