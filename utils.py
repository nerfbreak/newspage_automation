...
def _make_alert_box(text: str, bg_color: str, text_color: str, svg_path: str, border_left: str = "2px solid transparent", margin_top: str = "16px", margin_bottom: str = "24px") -> str:
    return clean_html(f"""
        <div style='
