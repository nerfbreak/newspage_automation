...
def make_success_box(text: str) -> str:
    ...
    return clean_html(f"""
        <div style='
            ...
            box-sizing: border-box;
        '>
            <span class="material-symbols-rounded" style="margin-right: 8px; font-size: 20px;">check_circle</span>
            {text}
        </div>
    """)
...
def make_error_box(text: str) -> str:
    ...
    return clean_html(f"""
        <div style='
            ...
            box-sizing: border-box;
        '>
            <span class="material-symbols-rounded" style="margin-right: 8px; font-size: 20px;">error</span>
            {text}
        </div>
    """)
