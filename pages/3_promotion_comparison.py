...
if promo_btn:
    ...
    promo_label_placeholder.markdown(f"""
        <div style='display: inline-flex; border: 2px solid #0F172A; box-shadow: 2px 2px 0px 0px #0F172A; margin-bottom: 8px; background-color: #FFFFFF; align-items: center;'>
            ...
            <span style='font-family: "Source Sans 3", sans-serif; font-size: 0.7rem; font-weight: 900; color: #0F172A; text-transform: uppercase; letter-spacing: 0.05em; padding: 4px 8px;'>PROMO_LOG</span>
        </div>
    """, unsafe_allow_html=True)
