...
if promo_btn:
    ...
    promo_label_placeholder.markdown(f"""
        <div style='display: inline-block; margin-bottom: 4px;'>
            ...
            <span style='font-family: "Source Sans 3", "Source Sans Pro", sans-serif; font-size: 10px; font-weight: 600; color: #e5e5e5; text-transform: uppercase; letter-spacing: 0.1em;'>PROMO_LOG</span>
        </div>
