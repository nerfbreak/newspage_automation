...
with left_col:
    ...
    MODULES = [
        ...
        {"title": "AI Assistant", "desc": "Asisten AI cerdas bertenaga DeepSeek-V4-Pro", "icon": "<svg width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><path d='M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z'></path></svg>", "bg": "#F0FDF4", "color": "#15803D", "page": "pages/7_ai_assistant.py", "key": "btn_ai"},
    ]
                ...
                with col:
                    with st.container():
                        ...
                        <span class='neo-module-card-marker' style='display:none;'></span>
                            <div style='display: flex; gap: 16px; margin-bottom: 12px; min-height: 76px; padding: 16px 16px 0px 16px; align-items: center;'>
                            <div style='width: 44px; height: 44px; border-radius: 0px; background: {mod["color"]}; color: #FFFFFF; display: flex; align-items: center; justify-content: center; border: 2px solid #0F172A; box-shadow: 2px 2px 0px 0px #0F172A;'>
                                {mod["icon"]}
                            </div>
                            <div style='flex: 1;'>
